...
import {makeStyles, Divider, Grid, Typography,Container, Button, Card,CardMedia, CardContent, Dialog,DialogTitle,CardActionArea, CardActions, Box, IconButton, CircularProgress} from "@material-ui/core";
    ...
    return (
        ...
        >
         ...
         <Close/>
          ...
          <CheckCircle fontSize="small" style={{color:"rgb(254,181,2)",marginLeft:"60px",fontSize:"130px"}}/>
          <Typography      
         variant="h6" style={{padding:"30px",textAlign:"center"}}>Added to cart</Typography>
        </Dialog>
